  ...
  try {
    ...
    const activity = await prisma.ecaActivity.create({
      data: {
        ...
        groupId: group.id,
        categoryId: categoryId || null,
        dayOfWeek: typeof dayOfWeek === 'string' ? parseInt(dayOfWeek, 10) : dayOfWeek,
        timeSlot,
        ...
        maxCapacity: maxCapacity ? parseInt(String(maxCapacity), 10) : null,
        staffId: staffId || null,
        cost: cost != null && cost !== '' ? parseFloat(String(cost)) : null,
